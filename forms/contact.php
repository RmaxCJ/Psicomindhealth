...
try {
   ...
   // $mail->isSMTP();                                            // Send using SMTP
    ...
    $mail->SMTPSecure = 'tls';
    $mail->Username   = 'psic.merin@psicomindhealth.com';                     // SMTP username
    $mail->Password   = 'Valeria16@';                               // SMTP password
    $mail->Port       = 465;

    $mail->setFrom($_POST['email'], $_POST['name']);
    $mail->addAddress('psicomindhealth@gmail.com','psicomindhealth.com');     // Add a recipient
